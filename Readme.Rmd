...
Cette application va permettre de choisir automatiquement un test statistique, parmifois les statistiques paramétriques et semi-paramétriques , offrant une analyse approfondie, et surtout automatique.
...
4.Le logiciel stoppe toutefois  dans le cas d'une seule variable sélectionné. Si une seule variable est sélectionné, il est demandé d'entrer une valeur de référence qui va alors servir de seconde moyenne, hypothétique, à comparer. <br>
...
Ainsi, ellesert de conteneur principal pour organiser divers composants de l'interface utilisateur tels que les titres, les barres latérales, les panneaux principaux, les graphiques et les tableaux. 
